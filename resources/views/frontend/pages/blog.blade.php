            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center mb-5">
                    <h2 class="display-4 fw-bold text-primary-custom position-relative d-inline-block">
                        <span class="section-title-bg">Our Blogs</span>
                        <span class="section-title-text">Our Blogs</span>
                    </h2>
                    ...
                    <div class="col-lg-4 col-md-6 project-item" data-category="ongoing hydropower">
                        <div class="project-card">
                            <div class="project-image">
                                <img src="{{ asset('upload/images/blogs/' . $blog->image) }}" alt="Hydropower Project"
                                    class="img-fluid">
                            </div>
                            <div class="project-overlay">
                                <div class="project-content">
                                    <h5>{{ $blog->title }}</h5>
                                    <p class="project-desc text-white">{!! $blog->short_description !!}
                                    </p>
                                </div>
                                <div class="project-hover-content">
                                    <a href="{{ route('frontend.details_blog', $blog->id) }}"
