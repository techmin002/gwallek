                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    value="access_leaves"
                                                                    {{ $role->hasPermissionTo('access_leaves') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    value="show_leaves"
                                                                    {{ $role->hasPermissionTo('show_leaves') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    value="create_leaves"
                                                                    {{ $role->hasPermissionTo('create_leaves') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    value="edit_leaves"
                                                                    {{ $role->hasPermissionTo('edit_leaves') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    value="delete_leaves"
                                                                    {{ $role->hasPermissionTo('delete_leaves') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    {{ $role->hasPermissionTo('access_attandance') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    {{ $role->hasPermissionTo('show_attandance') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    {{ $role->hasPermissionTo('create_attandance') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    {{ $role->hasPermissionTo('edit_attandance') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    {{ $role->hasPermissionTo('delete_attandance') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    value="access_orders"
                                                                    {{ $role->hasPermissionTo('access_orders') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    value="show_orders"
                                                                    {{ $role->hasPermissionTo('show_orders') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    value="create_orders"
                                                                    {{ $role->hasPermissionTo('create_orders') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    value="edit_orders"
                                                                    {{ $role->hasPermissionTo('edit_orders') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    value="delete_orders"
                                                                    {{ $role->hasPermissionTo('delete_orders') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    {{ $role->hasPermissionTo('access_messages') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    value="show_messages"
                                                                    {{ $role->hasPermissionTo('show_messages') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    {{ $role->hasPermissionTo('create_messages') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    value="edit_messages"
                                                                    {{ $role->hasPermissionTo('edit_messages') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    {{ $role->hasPermissionTo('delete_messages') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
