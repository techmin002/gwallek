<div class="modal fade" id="editMechanicalModal{{ $mechanical->id }}" tabindex="-1" role="dialog"
    aria-labelledby="editMechanicalLabel{{ $mechanical->id }}" aria-hidden="true">
        ...
        <div class="modal-content shadow-xl border-0" style="border-radius: 22px; overflow: hidden;">
            ...
            <div class="modal-header justify-content-center text-white"
                ...
                <h3 class="modal-title fw-bold">
                    <i class="fas fa-edit me-2"></i> Edit Mechanical
                </h3>
            </div>

            <form action="{{ route('mechanicals.items.update', $mechanical->id) }}" method="POST"
                ...
                <div class="modal-body p-4 bg-light">
                        ...
                        <div class="card-body row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" class="form-control shadow-sm"
                                    value="{{ $mechanical->name }}" required>
                            </div>
                            <div class="col-md-6">
                                ...
                                <select name="category_id" class="form-control shadow-sm" required>
                                    ...
                                    @foreach ($categories as $cat)
                                        <option value="{{ $cat->id }}"
                                            {{ $mechanical->category_id == $cat->id ? 'selected' : '' }}>
                                            {{ $cat->name }}
                                        </option>
                                    @endforeach
                                </select>
                                    ...
                                    <select name="branch_id" class="form-control shadow-sm" required>
                                        ...
                                        @foreach ($branches as $branch)
                                            <option value="{{ $branch->id }}"
                                                {{ $mechanical->branch_id == $branch->id ? 'selected' : '' }}>
                                                {{ $branch->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                @if ($mechanical->image)
                                    <div class="mt-2">
                                        <img src="{{ asset('upload/images/mechanicals/' . $mechanical->image) }}"
                                            alt="Mechanical Image" class="img-thumbnail shadow-sm"
                    ...
                    <div class="card shadow mb-4 border-0" style="border-left: 6px solid #0096c7;">
                        <div class="card-header text-white"
                            ...
                            <h5 class="fw-bold mb-0"><i class="fas fa-file-contract me-2"></i> Insurance Information
                            </h5>
                        </div>
                        <div class="card-body row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="date" name="insurance_date" class="form-control shadow-sm"
                                    value="{{ $mechanical->insurance_date }}">
                            </div>
                            <div class="col-md-6">
                                ...
                                @if ($mechanical->insurance_document)
                                    <div class="mt-2">
                                        <img src="{{ asset('upload/images/mechanicals/insurance/' . $mechanical->insurance_document) }}"
                                            alt="Insurance  Image" class="img-thumbnail shadow-sm"
                                            style="max-height: 120px; border-radius: 10px;">
                                    </div>
                                @endif
                            </div>
                        ...
                        <div class="card-body row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="date" name="service_date" class="form-control shadow-sm"
                                    value="{{ $mechanical->service_date }}">
                            </div>
                            <div class="col-md-6">
                                <label class="fw-semibold">Description</label>
                                <textarea name="description" class="summernote form-control shadow-sm" rows="3">{{ $mechanical->description }}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-secondary">
                            ...
                            <div class="card-body">
                                ...
                                <input type="checkbox" name="status" value="on"
                                    {{ $mechanical->status == 'on' ? 'checked' : '' }} data-bootstrap-switch
                ...
                <div class="modal-footer float-left bg-light">
                    ...
                    <button type="submit" class="btn btn-info px-4 text-white">
                        <i class="fas fa-save me-2"></i> Update Mechanical
                    </button>
                </div>
            </form>
        </div>
