@php
    ...
    if (auth()->user()->name === 'Super Admin') {
        ...
        $user = auth()->user();
        // Normal users see only their branch data
        $branchId = auth()->user()->branch_id;

        $totalbranch = Branch::where('id', $branchId)->count(); // or 1 if only one per branch
        $totaluser = User::where('branch_id', $branchId)->count();
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                            ...
                            <a href="{{ route('branches.index') }}" class="small-box-footer">More info <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
