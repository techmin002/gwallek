          ...
          <nav class="mt-2 mb-4">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                  ...
                  {{-- Finance --}}
                  @can('access_finance')
                  <li class="nav-item {{ request()->routeIs('due.sites') || request()->routeIs('cash-counter.*') || request()->routeIs('finance.depositedetails') || request()->routeIs('banks.*') ? 'menu-is-opening menu-open' : '' }}">
                      <a href="#"
                  ...
                  {{-- Product Mgnt --}}
                  @can('access_product')
                  <li class="nav-item {{ request()->routeIs('units.*') || request()->routeIs('brands.*') || request()->routeIs('categories.*') || request()->routeIs('products.*') ? 'menu-is-opening menu-open' : '' }}">
                      <a href="#"
