    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <form id="product-form" action="{{ route('clients.update', $client->id) }}" method="POST"
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control"
                                                    placeholder="Enter Full Name" value="{{ $client->name }}" required>
                                                @error('name')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="phone" class="form-control"
                                                    placeholder="Enter Contact " value="{{ $client->phone }}">
                                                @error('phone')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="designation" class="form-control"
                                                    placeholder="Enter designation" value="{{ $client->designation }}"
                                                    required>
                                                @error('designation')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="introduction" class="summernote" placeholder="Enter Answer">{{ $client->introduction }}</textarea>
                                                @error('introduction')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <img src="{{ asset('upload/images/clients/'.$client->image) }}" alt="{{ $client->title }}" width="200px">
                                                @error('image')
                                                        <p style="color: red">{{ $message }}</p>
                                                    @enderror
