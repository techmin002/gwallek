                              ...
                              <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $value->name }}</td>
                                        <td class="text-center"><img src="{{ asset('upload/images/clients/'.$value->image) }}" width="120px" alt="{{ $value->name }}"> </td>
                                        <td>{{ $value->email }}</td>
                                        <td>{{ $value->phone }}</td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            {{-- <a href="{{ route('clientss.show',$value->id) }}" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a> --}}
