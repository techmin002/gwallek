    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content shadow-lg" style="border-radius: 24px; border: none;">
            <div class="modal-header justify-content-center"
                ...
                <h3 class="modal-title fw-bold">Create Category</h3>
            </div>
                ...
                <div class="modal-body p-4">
                    <div class="row gy-3">
                        ...
                        <div class="col-md-12 mt-3">
                            ...
                            <textarea name="description" class="form-control" id="summernote" placeholder="Enter category description"></textarea>
                        </div>

                        <!-- Category Image -->
                        <div class="col-md-12 mt-3">
                            <label class="fw-semibold">Category Image</label>
