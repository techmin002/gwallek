                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="facebook" class="form-control"
                                                    placeholder="Enter Facebook Profile Link" value="{{ old('facebook') }}">
                                                @error('facebook')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="twitter" class="form-control"
                                                    placeholder="Enter Twitter Profile Link" value="{{ old('twitter') }}">
                                                @error('twitter')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="phone" class="form-control"
                                                    placeholder="Enter Contact " value="{{ old('phone') }}">
                                                @error('contact')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
