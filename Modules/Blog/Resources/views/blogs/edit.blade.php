                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id="product-form" action="{{ route('blogs.update', $blog->id) }}" method="POST"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="short_description" class="summernote" placeholder="Enter Short Description">{{ $blog->short_description }}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <img src="{{ asset('upload/images/blogs/' . $blog->image) }}"
                                                    alt="{{ $blog->title }}" width="200px">
                                                @error('image')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
